...
const AboutSection = () => {
  ...
  const fadeInUp = {
    ...
    transition: {
      ...
      ease: EASE_OUT,
      delay: 0.2, // Base delay 0.20s dewa hoyechhe
    },
  };
              ...
              {[
                {
                  ...
                  title: 'Our Mission',
                  desc: 'Driven by a team of dedicated educators, technologists, and visionaries.',
                },
                {
                  icon: <TrendingUp size={28} />,
                  title: 'Our Vision',
                  desc: 'A professional seeking to upskill, or a lifelong learner exploring new horizons.',
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
